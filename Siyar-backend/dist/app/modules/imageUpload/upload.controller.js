...
const uploadController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const uploadResult = yield new Promise((resolve, reject) => {
            const uploadStream = cloudinary_config_1.default.uploader.upload_stream({
                ...
                if (error) {
                    ...
                    console.log('Cloudinary upload successful:', result === null || result === void 0 ? void 0 : result.secure_url);
                    resolve(result);
                }
            });
        ...
        return res.status(201).json({
            ...
            data: {
                file_url: uploadResult === null || uploadResult === void 0 ? void 0 : uploadResult.secure_url,
                public_id: uploadResult === null || uploadResult === void 0 ? void 0 : uploadResult.public_id,
