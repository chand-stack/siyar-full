...
import type { SupportedLanguage, ArticleStatus } from '../../../../Redux/api/articleApi';
import { FaTimes, FaSave, FaImage, FaTags, FaGlobe, FaClock, FaStar, FaNewspaper, FaEdit, FaInfoCircle, FaFolder, FaBook } from 'react-icons/fa';
...
const CreateArticleModal: React.FC<CreateArticleModalProps> = ({ isOpen, onClose, onSuccess }) => {
